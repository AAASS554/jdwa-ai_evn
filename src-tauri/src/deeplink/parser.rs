...
//!
//! Parses jdwa:// and legacy ccswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a jdwa:// or ccswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// jdwa://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "jdwa" && scheme != "ccswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'jdwa' or 'ccswitch', got '{scheme}'"
        )));
    }
