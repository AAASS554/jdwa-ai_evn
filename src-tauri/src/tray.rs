    ...
    pub fn from_language(language: &str) -> Self {
        match language {
            "en" => Self {
                ...
                open_website: "Open JDWA Repository",
