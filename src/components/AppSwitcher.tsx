...
const ALL_APPS: AppId[] = ["claude", "codex", "gemini", "hermes", "openclaw"];
const STORAGE_KEY = "jdwa-last-app";
...
export function AppSwitcher({
  ...
  // Filter apps based on visibility settings (default all JDWA apps visible).
